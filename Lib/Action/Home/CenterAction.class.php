		...
		if($indent){
			foreach($indent as $i){
				...
				foreach($details as $d){
					...
					$arr.='
						<tr class="goods">
						  <td class="title"><a href="'.__ROOT__.'/Goods/details/id/'.$d['id'].'.html"><img src="'.__PUBLIC__.'/uploadify/uploads/commodity/'.$d['img'].'"/></a><div class="t_r"><a href="'.__ROOT__.'/Goods/details/id/'.$d['id'].'.html" class="t">'.$d['title'].'</a><br/><span class="t_c">颜色分类：'.$d['colorname'].'&nbsp;尺寸：'.$d['sizename'].'</span></div></td>	
